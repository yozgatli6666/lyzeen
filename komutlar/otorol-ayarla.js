...
if (!message.member.hasPermission("ADMINISTRATOR")) return message.channel.send(`<a:hypesquad:788769138486804551> **Bu komutu kullanabilmek için** "\`Yönetici\`" **yetkisine sahip olmalısın.**`);
 ...
 if(!kanal) return message.channel.send(`<a:hypesquad:788769138486804551>  **Lütfen Bir Kanal Belirt!** \n**__Örnek Kullanım__** : \`${prefix}otorol-ayarla @Rol #Kanal\``)
  ...
  message.channel.send(`╔▬▬▬▬▬▬▬▬HUNTER Otorol▬▬▬▬▬▬▬▬▬
║►  <a:hypesquad:788769138486804551> Otorol Aktif Edildi.
║► <a:hypesquad:788769138486804551> Rolü  **${rol}** Olarak Güncelledim! 
