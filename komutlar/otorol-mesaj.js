...
if (!message.member.hasPermission("ADMINISTRATOR")) return message.channel.send(`<a:hypesquad:788769138486804551> **Bu komutu kullanabilmek için** "\`Yönetici\`" **yetkisine sahip olmalısın.**`);
  ...
  if(mesaj.length < 5) return message.channel.send('<a:hypesquad:788769138486804551>  **Sayaç Hoşgeldin Mesaj Sistemi İçin En Az 5 Karakter Belirtebilirsin!**\n `**__Örnek__**: `-oto-rol-msg -uye- Hoşgeldin! senle beraber -uyesayisi- Kişiyiz!`')
  
 message.channel.send('<a:hypesquad:788769138486804551><a:hypesquad:788769138486804551> **Oto-Rol mesajı** `'+mesaj+'` **Olarak ayarlandı!**') 
